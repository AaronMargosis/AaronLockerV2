...
If specified, does not try to filter out random-named PowerShell scripts used to determine whether AppLocker script rules are in effect.
...
Set-Variable -Name sUnsafeDir   -Option Constant -value "UnsafeDir"
Set-Variable -Name sSafeDir     -Option Constant -value "SafeDir"
Set-Variable -Name sUnknownDir  -Option Constant -value "UnknownDir"
